...
public class ConfigProp {
    ...
    public ConfigProp(String originUrl, String stationEndpoint, String sensorEndpoint, String dataEndpoint, String summaryEndpoint, int expirationStations, int expirationSensors, int expirationSummary, int expirationData) {
